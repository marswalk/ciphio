...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (testBtn) testBtn.addEventListener("click", () => {
        document.getElementById("evolutionMessage").value = "";
    });
});
